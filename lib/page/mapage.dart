...
class Mapxd extends StatefulWidget {
  const Mapxd({super.key});

  @override
  State<Mapxd> createState() => _MapxdState();
}

class _MapxdState extends State<Mapxd> {
                            ...
                            ElevatedButton(
                              onPressed: () {
                                ...
                                map.currentState?.call("Route.add", args: [
                                  {"lat": 14.057898, "lon": 101.39359},
                                ]);
                                map.currentState?.call("Route.add", args: [
                                  {"lat": 14.092678, "lon": 101.37067},
                                ]);
                              },
